...
#'    \item{gs1}{I have overcome setbacks to conquer an important challenge}
#'    \item{gs2}{New ideas and projects sometimes distract me from previous ones.*}
#'    \item{gs3}{My interests change from year to year.*}
#'    \item{gs4}{Setbacks don’t discourage me.}
#'    \item{gs5}{I have been obsessed with a certain idea or project for a short time but later lost interest.*}
#'    \item{gs6}{I am a hard worker.}
#'    \item{gs7}{I often set a goal but later choose to pursue a different one.*}
#'    \item{gs8}{I have difficulty maintaining my focus on projects that take more than a few months to complete.*}
#'    \item{gs9}{I finish whatever I begin.}
#'    \item{gs10}{I have achieved a goal that took years of work.}
#'    \item{gs11}{I become interested in new pursuits every few months.*}
#'    \item{gs12}{I am diligent.}
#' }
#' 
#' @keywords datasets
#' 
