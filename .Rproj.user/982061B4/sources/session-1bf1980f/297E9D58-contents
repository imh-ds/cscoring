#' Calculate Regression-Weighted Composite Score Metrics (Weights & Loadings)
#' 
#' @description
...
#' help documents `?regression_loadings` and `?regression_weights` to see how
...
#' regression_metrics <- regression_metrics(data = grit,
#'                                          varlist = varlist,
