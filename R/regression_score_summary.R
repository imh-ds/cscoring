#' Calculate Regression-Weighted Composite Score Data & Metrics
#' 
#' @description
#' Create regression-weighted composite scores of scales by specifying
...
#' regression_summary <- regression_score_summary(data = grit,
#'                                                varlist = varlist)
#' 
#' @export
