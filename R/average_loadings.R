#' Calculate Unweighted Composite Score Loadings
#' 
#' @description
...
#' loadings are calculated as the bivariate correlation between the indicator
#' and the unweighted composite score.
#' 
...
#' average_loadings <- average_loadings(data = grit,
#'                                      varlist = varlist,
#'                                      weight = "average")
#' 
#' @export
average_loadings <- function(data = .,
                                  varlist){
